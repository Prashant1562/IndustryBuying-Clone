  ...
  return (
    ...
    {Data.data && console.log(Data.data.images[0])}
        { Data.data &&
            ...
            direction={{base:"column",sm:"column",md:"row"}} m="auto" mt="6rem" pb="10rem" width="85%">
      <Flex direction="column" justifyContent="space-between" width={{base:"100%",sm:"90%",md:"72%"}} boxShadow="rgba(0, 0, 0, 0.09) 0px 3px 14px">
...
{/* Product information section */}
        <Flex position="relative" justifyContent="space-between" p={{base:"0.5rem",sm:"1rem",md:"2rem"}}>
          ...
          <Flex direction="column" flex="1.4">
            ...
            <Box>
             <Box borderBottom="1px solid rgba(193, 192, 192,0.5)" mb="1rem" pl="1.5rem" pb="1rem">
             <Heading fontSize={16} color="#000000" textAlign="left">
              ...
              <Flex direction="column" justifyContent="left" gap="0.3rem" mt="1rem">
                <Link
                  to=""
                  style={{
                    fontSize: "13px",
              ...
              <Flex direction="column"  pl="0.5rem"  borderBottom="1px solid rgba(193, 192, 192,0.5)" mb="1rem" pb="1rem">
                <Heading
                  textAlign="left"
                  as="h1"
                  fontSize={16}
                ...
                <Flex justifyContent="left" gap="0.4rem" alignItems="center">
              ...
              <Flex direction="column" pl="0.5rem">
                <Heading as="h1" textAlign="left" ml="0.4rem" mb="0.7rem" fontSize={14} color="#444444">
                ...
                <InputGroup
                  ...
                  color="#FFFFFF"
                >
                  <Input color="black"  name="pincode" 
                
                  placeholder="Enter your Pincode" value={pincode} onChange={handleChange}/>
          ...
          >
            ...
            <Box flex="2" pl="2rem">
              <Flex gap="1rem">
              <RxTriangleRight/>
                <Text textAlign="left" fontSize={{base:"9px",sm:"11px",md:"14px"}} color="#666666">
                  Description
                </Text>
              </Flex>
              <Flex gap="1rem">
...
{/* Right hand Price section */}
      ...
      >
        ...
        >
          <Text fontSize={{base:"11px",sm:"13px",md:"15px"}} textAlign="left" as="b">
            Update Quantity
          </Text>
          <Flex justifyContent="space-between" alignItems="center" height="6rem" gap="0.8rem" direction={{base:"column",sm:"column",md:"row"}} >
            <Flex borderRadius="1px" height="2rem" direction={{base:"row",sm:"row",md:"row"}} width={{base:"auto",sm:"auto",md:"auto"}} alignItems="center" justifyContent="left">
              <Button borderRadius="1px" width="30%" height="100%" border="1px solid #A1A1A1" size="sm" bgColor="transparent" _hover={{backgroundColor:"rgba(240,240,240,0.5)"}} onClick={()=>handleonClick(-1)} isDisabled={count<=1}>-</Button>
              <Button borderRadius="1px" width="30%" border="1px solid #A1A1A1" size="sm" height="100%" isDisabled>{count}</Button>
              <Button borderRadius="1px" width="30%" border="1px solid #A1A1A1" size="sm" height="100%" bgColor="transparent" _hover={{backgroundColor:"rgba(240,240,240,0.5)"}} onClick={()=>handleonClick(1)} >+</Button>
            </Flex>
            <Flex flex="4"  width="60%" direction="column" pl="0.5rem" justifyContent="left">
              <Text fontSize={13} width="100%" textAlign="left">minimum order Quantity- 1</Text>
