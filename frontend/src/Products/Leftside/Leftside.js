...
import { AgriDataArray, BrandNames, DiscountInFilter, MinAndMax } from "../AgriData";
import "./LeftSide.css";
...
const Leftside = () => {
  ...
  return (
    ...
    >
      ...
      <Flex gap="0.5rem" pb="0.6rem" borderBottom="1px dashed rgba(185, 182, 182,0.5)">
      ...
      <Flex direction="column"  gap="2rem">
        <Box borderBottom="1px dashed rgba(185, 182, 182,0.5)" pb="0.6rem" margin="auto" width="100%">
          <Flex>
      ...
      <Flex>
           <Flex>
            <Heading as="h2" fontsize={22}>Brands</Heading>
            <Flex>
          <Box>
            <Stack spacing={4}>
              <InputGroup>
